                        ...
                        <div class="comments-list">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    ${(idKorisnika == value.idKorisnik)?'<button type="button" class="btn-danger btn-sm kom-delete btn-delete-kom" data-id="'+`${value.idKomentar}`+'"><i class="fas fa-trash-alt"></i></button>':''}
